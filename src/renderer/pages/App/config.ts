export const CONFIG: any = {
	...
	interactivity: {
		...
		events: {
			...
			onDiv: { selectors: '#repulse-div', enable: false, mode: 'repulse', type: 'circle' },
			onHover: { enable: true, mode: 'connect', parallax: { enable: false, force: 60, smooth: 10 } },
			resize: true,
		},
		modes: {
			attract: { distance: 200, duration: 0.4, easing: 'ease-out-quad', factor: 1, maxSpeed: 50, speed: 1 },
			bounce: { distance: 200 },
			bubble: { distance: 400, duration: 2, mix: false, opacity: 0.8, size: 40 },
	...
	particles: {
		...
		number: { density: { enable: true, area: 800, factor: 1000 }, limit: 500, value: 300 },
		opacity: {
